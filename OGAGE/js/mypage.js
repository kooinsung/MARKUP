...
//			$(this).removeClass('active');
//			$(this).siblings('.star_layer').hide();
//			$(this).data("show","yes");
//		}
//		else{
//			$(this).addClass('active');
//			$(this).siblings('.star_layer').show();
//			$(this).data("show","no");
//		}
//	});
//
//	$('.star_layer').each(function(){
//		$(this).find('li').on("click",function() {
//			var indexNum = $(this).index();
//			$(this).parent().parent().parent().hide();
//			$(this).parent().parent().parent().parent().find('.default_star2').show();
//			$(this).parent().parent().parent().parent().find('.default_star2 li').eq(indexNum).show();
//		});
//	});
	...
	//radio 선택
	$('.pay_radio input[type="radio"]').change(function() {
		var val = $(this).val();
		$('.pay_type_boxs > div').hide();
		$('.' + val).show();
	}); 

	//탭
	$('.s_tabs li a').on("click",function(e) {
		e.preventDefault();
		var num = $(".s_tabs li a").index($(this));
		$('.s_tabs li').removeClass();
		$(this).parent().addClass('active');
		$(".s_tabsConts > div").hide();
		$($(".s_tabsConts > div")[num]).fadeIn('fast');
	});
	...
	$('.btn_opt_change').on("click",function() {
		$(this).siblings('.change_layer').stop().fadeIn();
		$('.btn_close_change').click(function(){
