...
(function(root, factory) {
  ...
  Headroom.options = {
    ...
    scroller: window,
    classes : {
      pinned : 'pgds-header--pinned',
      unpinned : 'pgds-header--unpinned',
      top : 'pgds-header--top',
      notTop : 'pgds-header--not-top',
      bottom : 'pgds-header--bottom',
      notBottom : 'pgds-header--not-bottom',
      initial : 'pgds-header'
    }
  };
  ...
  $.fn.headroom = function(option) {
    return this.each(function() {
      ...
      if (!data) {
        ...
        data.init();
        $this.data('pgds-header', data);
      }
      if (typeof option === 'string') {
        data[option]();

        if(option === 'destroy'){
          $this.removeData('pgds-header');
        }
      }
    });
  };
