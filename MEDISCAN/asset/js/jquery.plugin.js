...
;(function ($) {
    ...
    var offsetPosition = function (id, mainBox, maxHeight) {
        var titleBox = mainBox.find('.option-title');
        var optionList = mainBox.find('.select-opts');
    ...
    var selectMenu = function (el, opts) {
        ...
        var arrow = opts.arrow ? '<div class="arrow" style="position: absolute; right: 16px; top: 45%;"></div>' : '';
        ...
        selectBox
            ...
            .each(function () {
                ...
                $(this).before('<div class="select-outer s_' + id + '" style="cursor: pointer;position: relative;"><div class="option-title" style="position: relative;"></div><div class="select-opts" style="display: none;position:absolute;width: 100%;z-index:1000"></div></div>');
                divOptionList = $('.select-outer.s_' + id + ' .select-opts');
            });
        ...
        var mainBox = $('.select-outer.s_' + id);
        var mainBoxTitle = mainBox.find('.option-title');
        ...
        mainBox
            .on(clickEvent + '.openlist' + id, function () {
                var otherSelectBoxes = $('.select-outer').not(this);

                $(this).toggleClass('opened').find('.select-opts').stop().slideToggle(100);

                if (otherSelectBoxes.hasClass('opened')) {
                    otherSelectBoxes.removeClass('opened').find('.select-opts').slideUp(100);
                }
            });

        // Mark real select option as selected
        $('.select-outer.s_' + id).on(clickEvent + '.selectoption' + id, '.option', function (e) {
    ...
    $(document).on(clickEvent + '.closeboxes', function (e) {
        var container = $('.select-outer');

        if (container.not(e.target) && !container.has(e.target).length && container.hasClass('opened')) {
            container.removeClass('opened').find('.select-opts').slideUp(100);
